...
export default async function AdminFlashcardsPage() {
  ...
  const { data: cards } = await supabase
    .from("flashcards")
    .select("id, word, pos, difficulty, definition")
    .order("difficulty")
    .order("word")
    ...
    <div className="max-w-4xl mx-auto px-4 py-6">
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <h1 className="text-display-sm mt-1" style={{ color: "#161d1d", fontFamily: "Source Serif 4, serif" }}>Flashcards</h1>
        </div>
